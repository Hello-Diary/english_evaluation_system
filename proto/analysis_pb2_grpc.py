...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proto/analysis_pb2_grpc.py depends on'
...
class TextAnalysisStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeText = channel.unary_unary(
                '/analysis.TextAnalysis/AnalyzeText',
...
def add_TextAnalysisServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'analysis.TextAnalysis', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('analysis.TextAnalysis', rpc_method_handlers)
